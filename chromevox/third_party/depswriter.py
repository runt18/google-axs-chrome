...
def _GetDepsLine(path, js_source):
  ...
  return 'goog.addDependency(\'{0!s}\', {1!s}, {2!s});\n'.format(path, provides, requires)
...
def _GetPair(s):
  ...
  try:
    ...
    raise Exception('Unable to parse input line as a pair: {0!s}'.format(s))
...
def main():
  ...
  out.write('// This file was autogenerated by {0!s}.\n'.format(sys.argv[0]))
